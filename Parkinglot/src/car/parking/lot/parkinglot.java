...
// creating parking lot//
    ...
    public void createParkingLot(String lotCount) {
        try {
            this.slot_size = Integer.parseInt(lotCount);
        } catch (Exception e) {
    ...
    // create PARK for registration number and color //
    ...
    // creating registration number from color //
    ...
    // creating  slot number from color //
    ...
    // creating slot number from registration number //
